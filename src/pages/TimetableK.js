...
const TimetableK = () => {
    ...
    <main className="section">
        <div className="container_timetable" >
            <iframe className="frame" src="https://teamup.com/ksskdqddz4emymrw6p" title="kvark">
            </iframe>
                                ...
                                <form  className={toggleState === 1 ? "content  active-content" : "content"}>
                                    ...
                                    <div>
                                        ...
                                        <select class="form-select" aria-label="Default select example">
                                            <option value="1">Амфитеатр (до 30 человек)</option>
                                            <option value="2">Круглый стол (до 8 человек)</option>
                                            <option value="3">Зона с телевизором (до 15 человек)</option>
                                        </select>
